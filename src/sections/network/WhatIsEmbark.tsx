...
const WhatIsEmbark = () => {
  return (
    <section className="bg-[#9CD8F6] border border-[#183453]/50  flex flex-col items-center justify-center py-40  mb-46">
      ...
      <p className="pt-8 text-2xl font-medium text-center leading-relaxed w-auto md:w-[68ch]">
